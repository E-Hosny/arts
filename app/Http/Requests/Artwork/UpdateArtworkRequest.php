...
class UpdateArtworkRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'price' => 'sometimes|required|integer|min:500|max:10000',
            'category' => 'sometimes|required|string|in:painting,sculpture,photography,digital_art,traditional_art,calligraphy,mixed_media',
    ...
    public function messages(): array
    {
        return [
            ...
            'status.string' => 'حالة العمل يجب أن تكون نص',
            'status.in' => 'حالة العمل الفني غير صحيحة',
        ];
    }
    ...
    protected function failedValidation(\Illuminate\Contracts\Validation\Validator $validator)
    {
        $response = response()->json([
            'success' => false,
            'message' => 'بيانات تحديث العمل الفني غير صحيحة',
